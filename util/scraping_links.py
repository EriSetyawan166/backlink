...
def scraping_links(driver) -> None:
    ...
    while True:
        ...
        links = wait.until(EC.presence_of_element_located(
        ...
        try:
            ...
            try:
                td_element = driver.find_element(
                    By.XPATH, "//*[@id='botstuff']/div/div[2]/table/tbody/tr/td[4]")
                a_element = td_element.find_element(By.TAG_NAME, "a")
                link_next = a_element.get_attribute("href")
                driver.get(link_next)
            except Exception as e:
                ...
                if i == 1:
                    print(
                        "Only getting 1 page links, try again if you think that it's not true")
                break
